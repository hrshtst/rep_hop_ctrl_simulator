...
void register_raibert(pybind11::module_ &m);
void register_regulator(pybind11::module_ &m);
void register_simulator(pybind11::module_ &m);
void register_logger(pybind11::module_ &m);
void register_ode(pybind11::module_ &m);
void register_ppp(pybind11::module_ &m);
